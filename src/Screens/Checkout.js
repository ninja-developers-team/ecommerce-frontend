                    ...
                    <div className="containerCheckout">
                        ...
                        <div className="row">
                            <div className="col-md-4 order-md-2 mb-4">
                                ...
                                <form  id="checkoutform" className="card p-2" onSubmit={this.handleDiscount}>
                            ...
                            <div className="col-md-8 order-md-1">
                                ...
                                <form className="needs-validation" novalidate>
                                    ...
                                    <hr className="mb-4" />
                                  <Link to="/">
                                        <button id="pay-btn" className="pay-btn-checkout" className="btn btn-primary " type="button">Pay</button>
                                    </Link>
