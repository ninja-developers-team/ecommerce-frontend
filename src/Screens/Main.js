...
export class Main extends Component {
    ...
    componentDidMount = async () => {
        ...
        const clothing2 = await axios.get(`https://fakestoreapi.com/products/category/men's clothing`)
        this.setState({
        ...
        const games = await axios.get(`https://www.cheapshark.com/api/1.0/deals?storeID=2&lowerPrice=100`)
        this.setState({
        ...
        return (
            <div className="row">
                {this.state.jeweleryData.length > 0 &&
                    (
                        <>
                            <CarouselMain jeweleryData={this.state.jeweleryData} path='/jewelery' category='Jewelery' />
                            <CarouselMain jeweleryData={this.state.clothing2Data} path='/clothing2' category={`Men' s clothing`} />
                            <CarouselMain jeweleryData={this.state.electronicsData} path='/electronics' category='Electronics' />
                            <CarouselMain jeweleryData={this.state.clothing1Data} path='/clothing1' category={`Women' s clothing`} />
                            <CarouselMain jeweleryData={this.state.gamesData} path='/games' category='Games' />
